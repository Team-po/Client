...
const summaryCards = [
	{
		...
		value: "2 Items",
		description:
			"GitHub 연동과 팀스페이스 조회 기능을 완료하고 피드백 반영 단계로 넘겼습니다.",
		icon: BadgeCheck,
		tone: "primary",
	},
	{
		...
		value: "2 Items",
		description:
			"팀스페이스에서 개발 가이드라인과 체크리스트 기능을 구현하고 있습니다.",
		icon: Clock3,
		tone: "accent",
	},
	{
...
const completedItems = [
	{
		title: "GitHub 연동 서비스",
		description:
			"프로젝트 저장소와 팀스페이스를 연결해 개발 활동을 서비스 흐름 안에서 확인할 수 있도록 GitHub 연동 기능 구현을 완료했습니다.",
		icon: Github,
	},
	{
		title: "팀스페이스 조회 기능",
		description:
			"팀스페이스에서 프로젝트 정보와 현재 진행 상태를 한눈에 확인할 수 있는 조회 기능 구현을 완료했습니다.",
		icon: FolderKanban,
	},
] as const;
...
export function TeamPoPresentationTwelfthView() {
					...
					<Container className="presentation-slide-inner relative rounded-[2rem] border border-border/60 bg-white/72 px-7 py-9 shadow-panel backdrop-blur-sm md:px-10 md:py-11">
						<div className="flex h-full min-h-0 flex-col gap-7">
							<div className="flex flex-wrap items-center gap-4">
								...
								<Badge variant="neutral">2026. 5. 13.</Badge>
						...
						<div className="flex h-full flex-col rounded-[2rem] border border-emerald-300/40 bg-[linear-gradient(180deg,rgba(236,253,245,0.98),rgba(255,255,255,0.98))] p-[1.625rem] shadow-panel">
							<div>
								...
								<p className="mt-[1.125rem] max-w-2xl text-base leading-8 text-emerald-950/80">
									GitHub 연동과 팀스페이스 조회 기능을 완료 목록으로
									이동했습니다.
								</p>
							</div>
							...
							<div className="relative flex h-full flex-col justify-between gap-4">
								<div>
									...
									<p className="mt-3 text-sm leading-6 text-amber-950/80">
										지금은 팀스페이스 안에서 개발 가이드라인과 체크리스트 기능을
										구현하는 단계입니다.
									</p>
								</div>
