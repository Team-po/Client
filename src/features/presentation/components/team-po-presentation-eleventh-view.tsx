...
const summaryCards = [
	{
		...
		value: "3 Groups",
		description:
			"매칭 시스템을 완료하고 팀 스페이스 전 단계까지 안정화한 뒤 배포했습니다.",
		icon: BadgeCheck,
		tone: "primary",
	},
	{
...
const completedItems = [
	{
		title: "매칭 시스템 구현 완료",
		description:
			"매칭 요청부터 상대방 확인, 수락·거절 처리까지 이어지는 핵심 매칭 흐름 구현을 완료했습니다.",
		icon: GitBranch,
	},
	{
		title: "팀 스페이스 전 단계 안정화",
		description:
			"유저 기능, 매칭 기능, 사용자 흐름, 코드 폴리싱까지 팀 스페이스 진입 전의 모든 기반 흐름을 안정화했습니다.",
		icon: FolderKanban,
	},
	{
		title: "완료 버전 배포",
		description:
			"현재 완료된 버전을 배포해 실제 접근 가능한 상태로 만들고 다음 기능 구현의 기준점을 마련했습니다.",
		icon: Rocket,
	},
] as const;
...
const inProgressItems = [
	{
		title: "프로젝트 개발 가이드라인 제공 서비스",
		description:
			"팀스페이스 안에서 프로젝트 상황과 역할을 바탕으로 개발 가이드라인을 제공하는 기능을 구현하고 있습니다.",
		icon: Sparkles,
		keywords: ["Team Space", "Dev Guide", "Developer Flow"],
	},
	{
		title: "체크리스트 서비스",
		description:
			"팀이 해야 할 작업을 작은 단위로 확인하고 진행 상태를 관리할 수 있는 체크리스트 기능을 구현하고 있습니다.",
		icon: ListChecks,
		keywords: ["Checklist", "Progress", "Task Flow"],
	},
	{
		title: "GitHub 연동 서비스",
		description:
			"프로젝트 저장소와 팀스페이스를 연결해 개발 활동을 서비스 흐름 안에서 확인할 수 있도록 GitHub 연동 기능 구현을 완료했고, 피드백을 반영하고 있습니다.",
		icon: Github,
		keywords: ["GitHub", "Repository", "Integration", "피드백 반영 중"],
	},
	{
		title: "팀스페이스 조회 기능",
		description:
			"팀스페이스에서 프로젝트 정보와 현재 진행 상태를 한눈에 확인할 수 있는 조회 기능 구현을 완료했고, 피드백을 반영하고 있습니다.",
		icon: FolderKanban,
		keywords: ["Team Space", "Overview", "Status", "피드백 반영 중"],
	},
] as const;
...
export function TeamPoPresentationEleventhView() {
	...
	return (
		...
		>
			...
			<main className="relative pb-16">
					...
					<Container className="presentation-slide-inner relative rounded-[2rem] border border-border/60 bg-white/72 px-7 py-9 shadow-panel backdrop-blur-sm md:px-10 md:py-11">
						<div className="flex h-full min-h-0 flex-col gap-7">
							<div className="flex flex-wrap items-center gap-4">
								...
								<Badge variant="neutral">2026. 5. 11.</Badge>
						...
						<div className="flex h-full flex-col rounded-[2rem] border border-emerald-300/40 bg-[linear-gradient(180deg,rgba(236,253,245,0.98),rgba(255,255,255,0.98))] p-[1.625rem] shadow-panel">
							<div>
								...
								<p className="mt-[1.125rem] max-w-2xl text-base leading-8 text-emerald-950/80">
									사용자 흐름과 코드 폴리싱을 포함해 팀 스페이스 전 단계의
									기반을 안정화했습니다.
								</p>
							</div>
				...
				<PresentationSlide
					description="현재 구현은 팀스페이스에서 프로젝트 개발 가이드라인, 체크리스트, GitHub 연동을 제공하는 협업 기능에 집중되어 있습니다."
					id="in-progress"
					label="02"
